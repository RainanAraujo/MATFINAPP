...
export default function Sobre() {
  return (
    <div className="flex flex-col gap-8 h-full">
      <Navbar title={"Sobre"} />
      <div className="h-full flex items-center justify-center flex-col gap-4 p-5">
        ...
        <p className="text-center text-gray-500">
          ...
          Educação de <b>Abias Rodrigues da Cruz</b>, sob a orientação do{" "}
          <b>Dr. Julio César Cardozo Rolón</b>, cujo título é: Eficácia da
